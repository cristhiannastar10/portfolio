  ...
  return (
    <Layout>
      <div className="bg-gray-800 text-white min-h-screen flex flex-col items-center py-10 px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold mb-6 text-center">HABILIDADES</h1>
        <div className="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-6 w-full max-w-4xl">
          <div className="bg-gray-300 rounded-full flex flex-col items-center justify-center p-6 w-full max-w-xs text-center">
          ...
          <div className="bg-gray-300 rounded-full flex flex-col items-center justify-center p-6 w-full max-w-xs text-center">
            ...
            <span className="text-black">Habilidades Deportivas: Cristhian es un deportista apasionado y dedicado, con habilidades destacadas en deportes como el fútbol y el atletismo. Su disciplina, trabajo en equipo y determinación son cualidades clave que lo distinguen en el campo deportivo.</span>
          </div>
          <div className="bg-gray-300 rounded-full flex flex-col items-center justify-center p-6 w-full max-w-xs text-center">
            <img src={pro3} alt="Habilidad Tecnológica" className="w-16 h-16 mb-4 rounded-full"/>
            <span className="text-black">Habilidades Tecnológicas: Como desarrollador de software en proceso, Cristhian ha adquirido habilidades en múltiples tecnologías de programación, incluyendo lenguajes como JavaScript, Python y Java, así como experiencia en el desarrollo web y móvil.</span>
          </div>
        </div>
      </div>
    </Layout>
